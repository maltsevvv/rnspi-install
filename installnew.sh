...
if grep -q 'VERSION="10 (buster)"' /etc/os-release; then
	...
	chown -R pi:pi /home/pi/.kodi/addon/repository.maltsev_kod18
	...
	chown -R pi:pi /home/pi/.kodi/addon/repository.maltsev_kod19
...
chown -R pi:pi /home/pi/addon/.kodi/skin.rnsd
